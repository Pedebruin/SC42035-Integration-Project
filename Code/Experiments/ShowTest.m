...
plot(ax1,Test.idd.y(:,1),'r.','MarkerSize',10,'DisplayName','TCL output 1');
plot(ax1,Test.idd.y(:,2),'b.','MarkerSize',10,'DisplayName','TCL output 2');
if strcmp(Test.TypeController,'lqr')
    plot(ax1,Test.idd.y(:,3),'r-','LineWidth',1,'DisplayName','Observer output 1');
    plot(ax1,Test.idd.y(:,4),'b-','LineWidth',1,'DisplayName','Observer output 2');
end    
plot(ax1, Test.idd.u(:,3), 'm-','LineWidth',1,'DisplayName', 'Reference 1');
...
plot(ax2, Test.idd.u(:,1), 'r-','LineWidth',2,'DisplayName', 'Input 1');
plot(ax2, Test.idd.u(:,2), 'b-','LineWidth',2,'DisplayName', 'Input 2');
